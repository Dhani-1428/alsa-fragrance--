...
export const translations: Record<Language, Translations> = {
  ...
  hi: {
    ...
    pages: {
      ...
      ibanInstructions: "IBAN ट्रांसफर निर्देश",
      ibanDescription: "कृपया निम्नलिखित IBAN खाते में भुगतान ट्रांसफर करें:",
      ibanPaymentNote: "एक बार भुगतान ट्रांसफर हो जाने के बाद, आपका ऑर्डर प्रसंस्कृत हो जाएगा। कृपया ट्रांसफर संदर्भ में अपना ऑर्डर नंबर शामिल करें।",
  ...
  ur: {
    ...
    pages: {
      ...
      ibanInstructions: "IBAN ٹرانسفر کی ہدایات",
      ibanDescription: "براہ کرم مندرجہ ذیل IBAN اکاؤنٹ میں ادائیگی ٹرانسفر کریں:",
      ibanPaymentNote: "ایک بار ادائیگی ٹرانسفر ہو جانے کے بعد، آپ کا آرڈر پروسیس ہو جائے گا۔ براہ کرم ٹرانسفر حوالہ میں اپنا آرڈر نمبر شامل کریں۔",
  ...
  fr: {
    ...
    pages: {
      ...
      ibanInstructions: "Instructions de virement IBAN",
      ibanDescription: "Veuillez transférer le paiement sur le compte IBAN suivant:",
      ibanPaymentNote: "Une fois le paiement transféré, votre commande sera traitée. Veuillez inclure le numéro de votre commande dans la référence du virement.",
  ...
  es: {
    ...
    pages: {
      ...
      ibanInstructions: "Instrucciones de transferencia IBAN",
      ibanDescription: "Por favor transfiere el pago a la siguiente cuenta IBAN:",
      ibanPaymentNote: "Una vez transferido el pago, tu pedido será procesado. Por favor incluye el número de tu pedido en la referencia de transferencia.",
